...
import com.ouharri.pharma.model.enums.TokenType;
...
public class UserServiceImpl extends _ServiceImp<UUID, UserRequest, UserResponsesDto, User, UserRepository, UserMapper> implements UserService {
    ...
    public Optional<UserResponsesDto> update(UserResponsesDto request) {
     ...
     * </p>
     */
    public UserResponsesDto getCurrentUser() {
    ...
    public UserResponsesDto changeRole(ChangeRoleRequest changeRoleRequest) {
        try {
     ...
     */
//    @Cacheable("managers")
    public Page<UserResponsesDto> getAllManager(Pageable pageable) {
     ...
     */
    public Page<UserResponsesDto> findConnectedUsers(Pageable pageable) {
